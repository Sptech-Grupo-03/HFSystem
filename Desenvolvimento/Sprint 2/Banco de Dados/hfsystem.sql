...
insert into fazenda (codigoFazenda, razaoSocial, nomeFantasia, cnpj, telefone, email, dataCadastro, fkEmpresa, fkEndereco) values
...
insert into clima (probabilidadeDeChuva, umidadeDoAr, temperaturaMinina, temperaturaMaxima, dtHrColeta, fkFazenda) values
...
insert into sensor (distanciaAgua, dtHrColeta, fkReservatorio) values
(1.5, '2024-10-18', 1),
(2.0, '2024-10-19', 2),
(1.0, '2024-10-20', 3),
(2.0, '2024-10-21', 4),
...
INSERT INTO historicoMedicao (idHistoricoMedicao, dtHrMedicao, nivelAgua, capacidadeCalculada, fkReservatorio) VALUES
